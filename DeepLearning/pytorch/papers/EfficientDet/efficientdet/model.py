...
class SeparableConvBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=None, norm=True, activation=False, onnx_export=False):
        ...
        self.norm = norm
        if self.norm:
            # Pytorch momentum is different from tensorflow.
...
class BiFPN(nn.Module):
    ...
    Args:
        num_channels:
        conv_channels:
        first_time: bool, whether the input comes directly from the efficientnet,
                    if True, downchannel it first, and downsample P5 to generate P6 then P7.
        epsilon: float, epsilon of fast weighted attention sum of BiFPN, not the BN's epsilon.
        onnx_export: bool, if True, use Swish instead of MemoryEfficientSwish.
    """
    ...
    def __init__(self, num_channels, conv_channels, first_time=False,
        ...
        if self.first_time:
            ...
            self.p4_down_channel = nn.Sequential(
                ...
                nn.BatchNorm2d(num_channels, momentum=0.01),
            )
...
class Regressor(nn.Module):
    ...
    def __init__(self, in_channels, num_anchors, num_layers, pyramid_levels=5, onnx_export=False):
        ...
        self.bn_list = nn.ModuleList(
            [nn.ModuleList([nn.BatchNorm2d(in_channels, momentum=0.01, eps=1e-3)
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, compound_coef, load_weights=False):
        ...
        # eg: efficient-b0 ~ efficientnet-b7, 0 ~ 7.
